...
import co.com.sofka.tallerautomotriz.mantenimiento.domain.tecnico.comands.ActualizarEspecialidad;
import co.com.sofka.tallerautomotriz.mantenimiento.domain.tecnico.comands.AgregarEspecialidad;

public class ActualizarEspecialidadUseCase extends UseCase<RequestCommand<ActualizarEspecialidad>, ResponseEvents>{

    @Override
    public void executeUseCase(RequestCommand<ActualizarEspecialidad> arg0) {
