...
public class Usuario extends AggregateEvent<UsuarioId> {
     ...
     */
    public void agregarFuncion(FuncionId funcionId){
        appendChange(new FuncionAgregada(funcionId)).apply();
    }
    ...
    public void agregarVehiculo(VehiculoId vehiculoId){
        appendChange(new VehiculoAgregado(vehiculoId)).apply();
    }
    ...
    public void actualizarVehiculo(VehiculoId vehiculoId){
        appendChange(new VehiculoActualizado(vehiculoId)).apply();
    }
